...
while not valid:
    ...
    if (prime_list[len(prime_list)-1])==lowest_prime_number:
        valid=True
        if (lowest_prime_number*lowest_prime_number)<=end_number:
            print("The such numbers are written below.")
            print(lowest_prime_number)
            print(lowest_prime_number*lowest_prime_number)
            for k in range((lowest_prime_number+1), ((end_number//lowest_prime_number)+1)):
                y=0
        ...
        elif lowest_number<=end_number:
            print("There is only one such number and that is", lowest_number, end="")
            print(".")
        else:
